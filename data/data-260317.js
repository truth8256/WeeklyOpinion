...
const PRESENTATION_CONFIG = {
    ...
    slides: [
        ...
        /* ─── 2. 허니문이 아닌 이유 ───────────────── */
        {
            ...
            data: {
                ...
                items: [
                    {
                        source: '문재인',
                        question: '야권 분화(국민의당·바른정당)\n→ 취임 초 국정지지 ≒ 여당지지',
                        options: ['야권 분화', '국정지지 ≒ 여당지지'],
                    },
                    {
                        source: '윤석열',
                        question: '출범 2개월 내\n국정지지 –9%p 급락',
                        options: ['–9%p 급락', '취임 2개월 내'],
                    },
                    {
                        source: '이재명',
                        question: '국민의힘 극단화\n→ 국정지지 여당지지 대비 +13%p 상회',
                        options: ['+13%p 상회', '국민의힘 극단화'],
                    },
                ],
            },
        },
        ...
        /* ─── 18. 역대 정부 수렴 ─────────────────── */
        {
            ...
            data: {
                title: "역대 정부 국정지지율",
                subtitle: "취임 후 30개월 추이 · 이재명 정부는 현재 어디에",
                // X축: 취임 후 3개월 단위, 각 정부 데이터를 취임 시점 기준으로 정렬
                // 문재인(2017.5): 2017.6~2022.3 / 박근혜(2013.2): 2013.3~2016.12
                // 윤석열(2022.5): 2022.5~2024.11 / 이재명(2025.6): 2025.7~2026.1
                dates: ['취임', '3개월', '6개월', '9개월', '12개월', '15개월', '18개월', '21개월', '24개월', '27개월', '30개월'],
                series: [
                    {
                        name: '이재명',
                        data: [64, 56, 60, null, null, null, null, null, null, null, null],
                        color: '#0052A3',
                    },
                    {
                        name: '문재인',
                        data: [81, 69, 72, 71, 76, 54, 46, 44, 46, 42, 47],
                        color: '#60A5FA',
                    },
                    {
                        name: '박근혜',
                        data: [42, 57, 63, 52, 57, 44, 46, 40, 38, 32, 50],
                        color: '#F59E0B',
                    },
                    {
                        name: '윤석열',
                        data: [51, 26, 29, 35, 35, 34, 34, 34, 23, 25, 19],
                        color: '#E61E2B',
                    },
                ],
                unit: '%',
